...
/*============== PUBLIC FUNCTION ======================*/
void skill_active(Numen * sender, Numen* receiver, Skills_id id_skill, int distance)
{
    if(!sender || !receiver || id_skill == NO_SKILL || distance < 0) return;

    skill_apply_effect (id_skill, sender, receiver, distance);
...
Status skill_apply_effect (Skills_id id, Numen *sender, Numen *reciver, int distance)
{
